...
+ (void)initialize {
    ...
    selectedTextAttrs[NSForegroundColorAttributeName] = UIColorFromRGB(0x333333);
...
- (void)setUpTabBar
{
    ...
    [self dropShadowOfTabBar:tabBar];
}
//设置阴影
-(void) dropShadowOfTabBar:(BXTabBar *)TabBar
{
    TabBar.layer.shadowColor = UIColorFromRGB(0x12b288).CGColor;
    TabBar.layer.shadowOffset = CGSizeMake(0, -5);
    TabBar.layer.shadowRadius = 5;
    TabBar.layer.shadowOpacity = 0.26;
}
...
- (void)addAllChildVc {
    ...
    CollegeViewController *College = [[CollegeViewController alloc] init];
    [self addOneChildVC:College title:@"大学" imageName:@"tabBar_icon_schedule_default" selectedImageName:@"tabBar_icon_schedule"];
    
    MineViewController *Mine = [[MineViewController alloc] init];
    [self addOneChildVC:Mine title:@"我的" imageName:@"tabBar_icon_schedule_default" selectedImageName:@"tabBar_icon_schedule"];
